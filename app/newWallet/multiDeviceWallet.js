...
class MultiDeviceWallet extends Component {
  ...
  renderCosigners() {
    ...
    return (<View>
      {
                cosignerControls.map(c => (<DagSelect
                  label={(`co-signer ${c}:`).toUpperCase()}
                  key={`co-signer ${c}`}
      ...
      <ScrollView>
        <BasePageLayout style={container.p30}>
          <DagForm>
            ...
            <DagSwitch
              label={'Single address wallet'.toUpperCase()}
              containerStyle={container.m20b}
            ...
            <DagSelect
              label={'total number of co-signers'.toUpperCase()}
            ...
            <DagSelect
              label={'required number of signatures'.toUpperCase()}
