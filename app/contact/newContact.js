  ...
  render() {
    return (
      <GeneralLayout style={StyleSheet.flatten([styles.container, this.props.style])}>
        <PageHeader canBack title={'New contact'.toUpperCase()} renderCustomAction={this.renderQrCodeButton.bind(this)} />
        <BasePageLayout style={StyleSheet.flatten([container.p20, container.p15t, container.p15b])}>
          <DagForm>
            <DagTextInput
              label={'Wallet address'.toUpperCase()}
              validators={[
                                          validators.required(),
