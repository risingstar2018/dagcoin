...
import {resolveAssetSource } from './sourceManager/index';
...
import {fetchSvg} from "./sourceManager/index";
...
class DagSvg extends Component{
    constructor(props){
        super(props);
    ...
    fetchSVGData(uri){
        return new Promise(((resolve, reject) => {
            try {
                fetchSvg(uri).then((svgContent) => {
                    const responseXML = svgContent;
